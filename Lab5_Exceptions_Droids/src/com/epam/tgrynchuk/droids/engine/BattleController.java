...
import com.epam.tgrynchuk.droids.exceptions.EmptyArmyException;
...
public class BattleController {
	...
	public void run() {
		...
		Menu mainMenu = new Menu(
				...
				new ReadCommandFromFile(),
				
				new SaveToFileCommand("file.dat", params),
		...
		for(;;) {
			...
			try {
				...
				if(e.getCause() != null) System.err.println(e.getCause().toString() );
				//e.printStackTrace();
				System.exit(1);
			}
		}
